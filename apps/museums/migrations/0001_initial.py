    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('w_hours', models.CharField(default=b'', max_length=100, verbose_name='Working hours', blank=True)),
                ('tickets', ckeditor.fields.RichTextField(default=b'', verbose_name="Ticket's cost", blank=True)),
                ('events', models.ManyToManyField(to='events.Event', null=True, blank=True)),
