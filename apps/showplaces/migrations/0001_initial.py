    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tickets', ckeditor.fields.RichTextField(default=b'', verbose_name="Ticket's cost", blank=True)),
                ('gallery', models.ManyToManyField(to='core.Gallery', null=True, blank=True)),
                ('locality', models.ForeignKey(blank=True, to='core.Locality', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': '\u0422\u0438\u043f \u0434\u043e\u0441\u0442\u043e\u043f\u0440\u0438\u043c\u0435\u0447\u0430\u0442\u0435\u043b\u044c\u043d\u043e\u0441\u0442\u044c',
        ...
        migrations.AddField(
            model_name='place',
            name='place_type',
            field=models.ForeignKey(blank=True, to='showplaces.PlaceType', null=True),
